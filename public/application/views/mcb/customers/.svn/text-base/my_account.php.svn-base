...
<?			} ?>
			<div id="customers_my_account_content">
				<div class="grey-border pink-corner personal_info">
					<img src="/env/images/mch/my_account_personal_info_title.png" /><br /><br />
...
<?					} ?>
					...
					<button type="submit">
						<img src="/env/images/mch/submit_button.png" />
					</button>
					</form>
<?					if ($errorsInForm) { ?>
					<script type="text/javascript">
...
<?					} ?>
				...
				<div class="grey-border pink-corner change_password">
					<img src="/env/images/mch/my_account_change_password_title.png" /><br /><br />
				...
				<div class="grey-border pink-corner previous_orders">
					<img src="/env/images/mch/my_account_previous_orders_title.png" /><br /><br />
<?					if (count($orders) == 0) { ?>
