...
2012-09-26 09:58:24 -04:00 --- error: Uncaught Kohana_Database_Exception: There was an SQL error: Table 'mch.order_ids' doesn't exist - SELECT `orders`.*, `order_statuses`.`status_name`, `users`.`firstname`, `users`.`lastname`, `order_ids`.`id` AS `order_id`
FROM (`orders`)
