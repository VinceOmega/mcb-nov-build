...
class Dashboard_Controller extends Template_Controller {
	...
	public $template = 'kohana/backend-template';

	public function index()
	{
		// In Kohana, all views are loaded and treated as objects.
		$this->template->content = new View('dashboard_content');

		// You can assign anything variable to a view by using standard OOP
		// methods. In my welcome view, the $title variable will be assigned
		// the value I give it here.
		$this->template->title = 'Welcome to My Chocolate Hearts and My Chocolate Coins!';
		...
		(
			...
			'Customers'    => '/customers',
			'Events'    => '/events',
			'Customer Designs'    => '/customer_designs',
			'Sales Report'    => '/reports/sales',
			'Sites'    => '/sites',
			'MCC Slideshow'    => '/slides',
		);
		if ($_SERVER['PHP_AUTH_USER'] == 'mch_superadmin') {
			$this->template->content->links = array_merge(
					$this->template->content->links,
					array(
			'Articles'	=> '/articles'	
					)
				);
