...
(
	'auth_net_login_id' => '7rA32Yjrk9',
	'auth_net_tran_key' => '3894R9AMf62vSbFH',
	'test_mode'     => FALSE,
	'md5_hash' => 'Z3nyatta1',
	'curl_config'   => array(CURLOPT_HEADER         => FALSE,
	                         CURLOPT_RETURNTRANSFER => TRUE,
...
$config['Authorize'] = array
(
	'auth_net_login_id' => '3k889VwDwq',
	'auth_net_tran_key' => '8hFkq24EGkY6D469',
	'curl_config'   => array(CURLOPT_HEADER         => FALSE,
	                         CURLOPT_RETURNTRANSFER => TRUE,
	                         CURLOPT_SSL_VERIFYPEER => FALSE)
);
...
(
	'test_mode'     => FALSE,
	'USER'         => 'info_api1.chocolatefavorworld.com',
	'PWD'          => '9DYWKK5XBW2G2XGX',
	'SIGNATURE'    => 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-AYW9BOStGuFMR9mvj4VQs3OG.y8b',
	'ENDPOINT'     => 'https://api-3t.paypal.com/nvp',

	'RETURNURL'     => 'http://www.mychocolatehearts.com/shopping_cart/paypal_ok',
	'CANCELURL'     => 'http://www.mychocolatehearts.com/shopping_cart/paypal_cancel',

	// -- sandbox authorization details are generic
	'SANDBOX_USER'      => 'alexan_1337281310_biz_api1.gmail.com',
	'SANDBOX_PWD'       => '1337281335',
	'SANDBOX_SIGNATURE' => 'Aa7MpNHt-nLdG3l-ON1HoRbz.wGbAcqUSV9ycvxE4YFaA1M8j9521cKl',
