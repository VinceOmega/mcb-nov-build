...
$post['wrapper'] = '/env/html5_configurator/exec_wrapper/AquaVines_1lb.png';
...
$base->compositeImage($layout, Imagick::COMPOSITE_DISSOLVE, $x, $y);
	}

$bar = $base->writeImage('/var/www/mch/public/test_wrapper.png');
$base->destroy();
	if($bar){
$barpath = "test_wrapper.png";
...
$line_1_x = ($line_1_x < 0 ? 0 : $line_1_x); //$line_1_x = ($line_1_x > 198 ? 198: $line_1_x);
$line_2_x = ($line_2_x < 0 ? 0 : $line_2_x); //$line_2_x =  ($line_2_x > 198 ? 198: $line_2_x);
$line_3_x = ($line_3_x < 0 ? 0 : $line_3_x); //$line_3_x =  ($line_3_x > 198 ? 198: $line_3_x);
$line_4_x = ($line_4_x < 0 ? 0 : $line_4_x); //$line_4_x = ($line_4_x > 198 ? 198: $line_4_x); 
