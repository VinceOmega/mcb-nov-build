...
class Slides_Controller extends Base_Controller {

	public $tableCols = array('image_alt','order', 'site_id');
...
//	}
				...
				if (!empty($_FILES['image']['name'])){
					...
					if ($_FILES->validate())
					{
						...
						Image::factory($filename)
							...
							->save(DOCROOT.'../../env/images/mcc/slideshow/'. $file, FALSE);
	...
	public function _renderView(){
		...
		$view->content = new View('slides_content');
