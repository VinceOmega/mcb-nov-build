			...
			<div id="product-builder">
                ...
                <div class="unsupported">
					...
					<p>Or, if you need quick chocolate in bulk, please browse our bulk Grab and Go Chocolate Hearts options with fast shipping by <a href="/products/category/grab_and_go">clicking here</a>.</p>
                </div>
                <?php }else{ ?>
				<center>
				<div id="flash_render">
