...
?>
				...
				<div class="left item3">
					<center><img src="/env/images/step1.png" /></center>
...
?>
          ...
          <div id="shipping-methods">
			...
			<!--<img src="/env/images/continue.png" alt="Submit" onClick="if(!checkDate()) return false; on_submit_validation();" style="margin-bottom: 30px;vertical-align:top;" class="right">-->
			<img src="/env/images/continue.png" alt="Submit" onClick="on_submit_validation();" style="margin-bottom: 30px;vertical-align:top;" class="right">
