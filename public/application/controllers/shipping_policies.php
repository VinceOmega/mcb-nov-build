 ...
 */
class Shipping_policies_Controller extends My_Template_Controller {
	...
	{
		$this->description = 'MyChocolateCoins.com terms and policies.';
		$this->title = 'MyChocolateCoins.com Terms and Policies - Custom Chocolate Coins: Create customized chocolate coins with your own design';
	...
	{
		$this->description = 'MyChocolateHearts.com terms and policies.';
		$this->title = 'MyChocolateHearts.com Terms and Policies - Custom Chocolate Hearts: Create customized chocolate hearts with your own design';
		$this->keywords = 'chocolate hearts, custom chocolate hearts, personalized chocolate hearts, chocolate favors, custom chocolate favors, party favors, personalized chocolate favors, chocolate casino chips, chocolate poker chips, custom chocolate casino chips, casino party favors, wedding favors, personalized wedding favors, baby shower favors, bridal shower favors, chocolate gelt, chocolate gold hearts, chocolate party favors, chocolate candy favors, custom chocolate, custom chocolate poker chips, corporate favors';
	}

	protected function setTexts_MCB()
	{
		$this->description = 'MyChocolateBars.com terms and policies.';
		$this->title = 'MyChocolateBars.com Terms and Policies - Custom Chocolate Bars: Create customized chocolate hearts with your own design';
		$this->keywords = 'chocolate hearts, custom chocolate hearts, personalized chocolate hearts, chocolate favors, custom chocolate favors, party favors, personalized chocolate favors, chocolate casino chips, chocolate poker chips, custom chocolate casino chips, casino party favors, wedding favors, personalized wedding favors, baby shower favors, bridal shower favors, chocolate gelt, chocolate gold hearts, chocolate party favors, chocolate candy favors, custom chocolate, custom chocolate poker chips, corporate favors';
